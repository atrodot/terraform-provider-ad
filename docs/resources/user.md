---
# generated by https://github.com/hashicorp/terraform-plugin-docs - modified for atrodot/ad fork
...
- `cn` (String) The Common Name (CN) of the AD user object. If not specified, defaults to `display_name`. Use this to set a CN that differs from the display name.
